...
('5YJSA1DP9DFP78910', 1, 75000.00, '2025-08-05', 'Ethan Davis'),
('JHMCM56557C404040', 2, 24000.00, '2025-07-22', 'Emma Wilson'),
('1GCHK23D47F789123', 3, 48000.00, '2025-06-30', 'Noah Thompson'),
('WBA3A5C52DF123321', 4, 41000.00, '2025-05-18', 'Ava Anderson'),
('1HGCM82633A004352', 5, 22500.00, '2025-04-10', 'Mason Clark'),
('2T1BURHE0FC123456', 6, 21500.00, '2025-03-25', 'Isabella Lewis');
...
CREATE TABLE lease_contracts (
    ...
    party_a VARCHAR(100),  -- dealership name or id 
    party_b VARCHAR(100),  -- customer name or id 
    ...
    disposition_fee DECIMAL(10,2) DEFAULT 0,

    contract_status ENUM('Active','Completed','Terminated') DEFAULT 'Active',

    FOREIGN KEY (vin) REFERENCES vehicles(vin)
    -- FOREIGN KEY (customer_id) REFERENCES customers(customer_id) -- Uncomment when you create the customers table
);

INSERT INTO lease_contracts (
    customer_id, vin, party_a, party_b,
    lease_start_date, lease_end_date,
    monthly_payment, down_payment, security_deposit,
    lease_term_months, contract_status
) VALUES
-- 1
(1, '2T1BURHE0FC123456', 'AutoWorld Dealership', 'John Doe',
 '2025-01-15', '2028-01-15',
 399.99, 1500.00, 500.00,
 36, 'Active'),

-- 2
(2, '5YJSA1DP9DFP78910', 'Premium Motors', 'Sarah Johnson',
 '2025-03-01', '2028-03-01',
 455.50, 2000.00, 600.00,
 36, 'Active'),

-- 3
(3, '1FAFP404X1F102030', 'City Auto Group', 'Michael Smith',
 '2024-11-10', '2027-11-10',
 379.00, 1000.00, 500.00,
 36, 'Completed'),

-- 4
(4, '1GCHK23D47F789123', 'AutoWorld Dealership', 'Emily Carter',
 '2025-04-20', '2028-04-20',
 499.99, 2500.00, 700.00,
 36, 'Active'),

-- 5
(5, '1HGCM82633A004352', 'Prime Auto Leasing', 'David Wilson',
